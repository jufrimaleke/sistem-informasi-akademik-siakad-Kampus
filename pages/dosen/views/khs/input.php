              ...
              <?php foreach ($khs as $row) : ?>
                <tr>
                  ...
                  <td style="width:300px"><?= $row["nama"] ?></td>
                   <td><input type="number" name="kehadiran[]" value="<?= $row['kehadiran'] ?>" class="form-control" style="width: 75px;" value=""></td>
                  ...
                  <td><input type="number" name="nilai_akhir[]" value="<?= $row['nilai_akhir'] ?>" class="form-control" style="width: 75px;" value=""></td>
                  <td>
...
if (isset($_POST['simpan'])) { // Jika user mengklik tombol Simpan
  ...
  echo "
    <script>
        alert('Nilai berhasil diupdate/input.');
        window.history.back();
    </script>";
}
?>
