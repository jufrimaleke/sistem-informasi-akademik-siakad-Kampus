              ...
              <div class="box-body">
                <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nip" id="nip" readonly="on" value="<?= $dosen["nip"]; ?>">
                  </div>
                  <div class="form-group">
                    <label for="nama">Nama Dosen</label>
                    <input type="text" class="form-control" name="nama" id="nama"  value="<?= $dosen["nama_dosen"]; ?>" required>
                  </div>
                   <div class="form-group">
