...
$pdf->Cell(200, 10, 'KARTU RENCANA STUDI MAHASISWA', 0, 1, 'C');
...
$pdf->Cell(3,7,':',0,0);
$pdf->Cell(100,7,$idthnakad,0,1); // semester
...
$dataKRS = mysqli_query($conn, "SELECT * FROM khs 
    ...
    WHERE khs.nim = '$nim' AND khs.id_semester = '$idthnakad'");
...
// $pdf->SetFont('Times','B',12);
// $pdf->Cell(20, 5, '', 0, 0);
// $pdf->Cell(30, 5, 'Dosen Pembimbing', 0, 0);
// $pdf->Cell(94, 5, '', 0, 0);
...
$pdf->SetFont('Times','B','12');
$pdf->Cell(90,7,$nama['nama'],0,0,'C'); // Nama dosen
...
$pdf->Cell(190, 7, $kapro['nama_dosen'], 0, 0, 'C');
...
$pdf->Cell(0, 10, 'Dokumen ini dicetak oleh:' . $admin, 0, 0, 'L');
