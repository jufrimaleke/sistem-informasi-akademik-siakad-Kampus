<?php 
 ...
 <section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"> Monitoring Approve</li>
  </ol>    
  </section>
                ...
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                   ...
                   if (isset($_POST['filter'])) {
                      ...
                      $query = "SELECT mahasiswa.nim, mahasiswa.nama, jurusan.nama_jurusan, approve.id_semester, approve.status, semester.nama_semester, approve.approve_by, approve.approve_date, approve.id
                          FROM approve 
                  ...
                  <tr>                  
                    ...
                    <td style="text-align: center;">
	                   ...
	                   <a href="?page=monitoring&aksi=hapus&id=<?= $row["id"]; ?>"onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> Hapus</a>
                 	</td>
