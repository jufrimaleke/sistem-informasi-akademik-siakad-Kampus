                ...
                <tbody>
                    ...
                    if (isset($_POST['filter'])) {
                        ...
                        $jadwal = mysqli_query($conn, "SELECT * FROM jadwal
                            ...
                            INNER JOIN jurusan ON jadwal.id_jurusan = jurusan.id_jurusan WHERE jadwal.id_semester = '$prd' AND jadwal.id_jurusan = '$jrs'");
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a href="?page=khs&aksi=input&id_jadwal=<?= $row["id_jadwal"]; ?>"><span class="btn btn-success"><i class="fa fa-list">Lihat Peserta</i></span></a>
                                </td>
                            </tr>
                    <?php endforeach;
                    } else {
                        echo '<tr><td colspan="6" class="text-center bg-success"><b>P I L I H  F I L T E R</b></td></tr>';
                    }
                    ?>
                </tbody>
