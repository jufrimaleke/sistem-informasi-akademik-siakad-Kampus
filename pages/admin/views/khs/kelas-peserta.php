 <?php 
  ...
  $id_semester = $_SESSION["idPrd"] = $dataPrd;
 ...
 <!-- SELECT2 EXAMPLE -->
      <div class="box box-default">
        ...
        <?php foreach ($krs as $row) : ?>
          ...
          <h3 class="box-title"><?= $row["nip"] ?> - <?= $row["nama_dosen"] ?> </h3>
        <?php endforeach; ?>
     ...
     <div class="box-body">
      ...
      <form method="POST" action="" enctype="multipart/form-data">
              <!-- <a target="_blank" class="btn btn-success" href="views/khs/export_excel.php">Download Peserta Kelas</a> -->

              
              <a href="views/khs/cetak.php?nip=<?= $row["nip"] ?>&kode_mk=<?= $row["id_jadwal"] ?>" target="_blank" class="btn btn-warning btn-ms">
