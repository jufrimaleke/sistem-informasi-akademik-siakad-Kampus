              ...
              <div class="box-body">
                <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="nip" id="nip" placeholder="NIP / NIDN" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="tanggal" id="tanggal" placeholder="Tanggal Lahir" required>
                  </div>
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  ...
                  <button type="submit" name="submit" value="tambah" class="btn btn-primary">Simpan</button>
                       <a href="index.php?page=dosen" class="btn btn-danger">Batal</a>
                  </div>          
                </div>
              <!-- /.box-body -->            
