...
$_SESSION['nim'] = $_POST['data_nim'];

$id_semester = $_SESSION['idsemester'];
$data_nim = $_SESSION['nim'];
  ...
  $khs = mysqli_query($conn, "SELECT * FROM jadwal 
          ...
          WHERE khs.nim = $data_nim AND khs.id_semester = $id_semester"); 
?>
...
<div>
 ...
 <section class="content">
      <div class="row">
        <div class="col-xs-12">
        <a target="_blank" href="views/khs_mhs/cetak.php?nim=<?php echo $data_nim ?>" class="btn btn-success btn-ms" class="pull-right"><span class="glyphicon glyphicon-print"></span> Cetak </a>
            <div class="box-body">
