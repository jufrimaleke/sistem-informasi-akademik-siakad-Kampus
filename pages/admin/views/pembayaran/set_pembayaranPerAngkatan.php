...
<section class="content">
	<div class="row">
		<form action="views/pembayaran/proses_setPembayaran.php" method="POST">
		<div class="col-md-6">
	                ...
	                <div class="form-group">
	                    ...
	                    <select name="angkatan" required class="form-control" id="angkatan">
	                        ...
	                        <?php foreach ($angkatan as $row): ?>
	                            <option value="<?= $row["id_angkatan"]; ?>"><?= $row["id_angkatan"]; ?></option>
	                        <?php endforeach; ?>
	                    </select>
	                </div>
	                <div class="form-group">
	                    <label for="jrs">Jurusan :</label>
	                    <select name="jrs" required class="form-control" id="jrs">
	                        <option value="">-- Pilih -- </option>
						...
						<table class="table">
							<tbody>
								<tr>
									...
									<td><input type="text" class="form-control" id="payment_tipe" name="tipe" readonly required>
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<input type="text" required name="jumlah_pembayaran" id="biayaInput" readonly class="form-control" required oninput="formatBiaya()" onfocusout="formatBiaya()">
									</td>
								</tr>
							</tbody>
						</table>
