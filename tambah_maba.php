...
<head>
  ...
  <title>Halaman Input Maba</title>
  ...
  <link rel="shortcut icon" type="text/css" href="assets/img/Logo.jpg">
  <!-- Google Font -->
                                    ...
                                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                        <fieldset><br>
                                           <?php
                                            ...
                                            <button type="submit" class="btn btn-primary" name="kirim">Kirim</button><br><br><br>
                                        </fieldset>
                                    </form>
                                </div>
                            </div>
